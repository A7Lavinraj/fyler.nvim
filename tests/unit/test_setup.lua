...
T["configuration"] = function()
  ...
  expect_config("views.finder.columns.git.symbols.Modified", "*")
  expect_config("views.finder.columns.git.symbols.Deleted", "x")
  expect_config("views.finder.columns.git.symbols.Renamed", ">")
